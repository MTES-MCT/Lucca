 ...
 *     },
 * }
 * @psalm-type LuccaAdherentConfig = array<mixed>
 * @psalm-type LuccaContentConfig = array<mixed>
 * @psalm-type LuccaCoreConfig = array{
 *     asset_version?: scalar|null|Param, // Version applied on all assets sended by server. Which version of file has been deployed ? // Default: "1.0"
 *     lucca_unit_test_dep_code?: scalar|null|Param, // Parameter used to define the department code for unit tests. // Default: null
 *     asset_forceRefresh?: scalar|null|Param, // Flag to force refresh all assets - combined with version configuration. // Default: false
 *     google_analytics_id?: scalar|null|Param, // Configure Google Analytics id to add script and register traffic
 *     aigle_api_base_url?: scalar|null|Param, // Configure Aigle API base url to connect to Aigle services
 *     aigle_api_key?: scalar|null|Param, // Configure Aigle API key to connect to Aigle services
 * }
 * @psalm-type LuccaChecklistConfig = array<mixed>
 * @psalm-type LuccaLogConfig = array<mixed>
 * @psalm-type LuccaMediaConfig = array{
 *     upload_directory?: scalar|null|Param,
 *     upload_tmp_directory?: scalar|null|Param,
 *     elements_to_load_scroll?: scalar|null|Param, // Default: 20
 * }
 * @psalm-type LuccaModelConfig = array<mixed>
 * @psalm-type LuccaParameterConfig = array<mixed>
 * @psalm-type LuccaSecurityConfig = array{
 *     type: "form"|"cas"|"google"|Param,
 *     default_url_after_login: scalar|null|Param, // This is the default url called after a success login attempt.
 *     default_admin_url_after_login: scalar|null|Param, // This is the default admin url called after a success login attempt.
 *     authentication_api_key?: scalar|null|Param, // Key used to authenticate user on this main API.
 *     proconnect_auth_url?: scalar|null|Param, // ProConnect authentication URL. // Default: "https://proconnect.lucca.fr/auth/realms/lucca/protocol/openid-connect/auth"
 *     proconnect_callback_url?: scalar|null|Param, // ProConnect callback URL. This is the URL where ProConnect will redirect after authentication. // Default: ""
 *     proconnect_client_id?: scalar|null|Param, // ProConnect client ID. // Default: "lucca"
 *     proconnect_client_secret?: scalar|null|Param, // ProConnect client secret. // Default: ""
 *     lucca_rest_api_key?: scalar|null|Param, // API key used to secure REST API to get tokens. // Default: "secret_key"
 *     lucca_rest_api_username?: scalar|null|Param, // Username used to identify REST API user. // Default: "rest_api_username"
 *     lucca_rest_api_jwt_expiration?: scalar|null|Param, // Expiration time (in seconds) for REST API JWT tokens. // Default: 14400
 *     protection?: array{
 *         max_login_attempts?: int|Param, // This value is used to block login attempts. // Default: 5
 *         period_max_in_min?: int|Param, // Scan every login attempts in last xx minutes. How many ? // Default: 30
 *         period_clean_in_day?: int|Param, // Scan every login attempts in last xx days to unban them. How many ? // Default: 3
 *     },
 * }
 * @psalm-type LuccaSettingConfig = array<mixed>
 * @psalm-type LuccaUserConfig = array<mixed>
 * @psalm-type LuccaFolderConfig = array{
 *     avoid_break_page?: scalar|null|Param,
 * }
 ...
 *     lucca_adherent?: LuccaAdherentConfig,
 *     lucca_content?: LuccaContentConfig,
 *     lucca_core?: LuccaCoreConfig,
 *     lucca_checklist?: LuccaChecklistConfig,
 *     lucca_log?: LuccaLogConfig,
 *     lucca_media?: LuccaMediaConfig,
 *     lucca_model?: LuccaModelConfig,
 *     lucca_parameter?: LuccaParameterConfig,
 *     lucca_security?: LuccaSecurityConfig,
 *     lucca_setting?: LuccaSettingConfig,
 *     lucca_user?: LuccaUserConfig,
 *     lucca_folder?: LuccaFolderConfig,
 *     "when@dev"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
