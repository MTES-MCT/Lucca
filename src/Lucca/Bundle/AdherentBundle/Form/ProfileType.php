...
use Symfony\Component\Form\Extension\Core\Type\{TextType, ChoiceType, EmailType};
...
class ProfileType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('email', EmailType::class, array('label' => 'label.email', 'required' => true, 'mapped' => false));
    }
